...
import styles from "styles/contact/center.module.css"
...
import CircularProgressWithLabel from "src/components/loader/CircularProgressWithLabel"
...
const App = () => {
  ...
  const onSubmitClick = async () => {
    ...
    await db.collection("contents").doc("app").collection("contact").doc().set({uid:user.uid, text:input, type:selectedType, createdAt: new Date()})
