...
// ** Demo Tabs Imports
import TabAccount from 'src/components/admin/content/accountSettings/TabAccount'
import TabSecurity from 'src/components/admin/content/accountSettings/TabSecurity'
